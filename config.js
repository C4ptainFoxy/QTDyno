module.exports = {
    "registercommands" : false,
     "token": "OTIzMjU1ODYxMTU2MTIyNjI0.G4DzBc.1uA9uNExdhP35ZAf7Cs0zonmV8Pid6ueSCZYdc",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "fr", //The basic language of the bot, "fr" for French and "en" for English
    ...
    start: {
        loading: "Waking up", //Loading status
        activity: "FoxCraftChill" //Status
    },
    ...
    grole: "Staff", //If the member doesn't have permission to handle messages he can still use the giveaways commands if he has the role configured right here

    auth: {
        support: "https://discord.gg/3b7Hj7xcgH", //The link of your Discord server
